...
{
    public class FillSentenceViewModel : MemoriseBaseViewModel
    {
        ILearningService learningService;
        public FillSentenceViewModel(ILearningService learningService)
        {
        ...
        protected async override void InitFromBundle(IMvxBundle parameters)
        {
            ...
            Item = await learningService.GetUnitByType(UnitModel.UnitType.FillSentence);
