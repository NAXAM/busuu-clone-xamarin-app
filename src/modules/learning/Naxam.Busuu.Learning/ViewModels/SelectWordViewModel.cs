...
{
    public class SelectWordViewModel : MemoriseBaseViewModel
    {
        ILearningService learningService;
        public SelectWordViewModel(ILearningService learningService)
        {
        ...
        protected async override void InitFromBundle(IMvxBundle parameters)
        {
            ...
            Item = await learningService.GetUnitByType(UnitModel.UnitType.SelectWord);
