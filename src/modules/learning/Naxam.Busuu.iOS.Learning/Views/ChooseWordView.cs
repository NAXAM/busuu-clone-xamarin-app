...
{
    public partial class ChooseWordView : MemoriseBaseView
    {
		bool IsAnimationBtn;
		AVAudioPlayer SpeakMusicPlayer;
		public event EventHandler<AnswerModel> AnswerClick;

		public ChooseWordView(IntPtr handle) : base(handle)
		{
		}

		public static ChooseWordView Create(UnitModel item)
		{
			var arr = NSBundle.MainBundle.LoadNib("ChooseWord", null, null);
			var v = Runtime.GetNSObject<ChooseWordView>(arr.ValueAt(0));
			v.Item = item;
			v.InitData();
			return v;
		}
