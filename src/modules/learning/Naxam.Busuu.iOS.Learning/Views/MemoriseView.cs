...
namespace Naxam.Busuu.iOS.Learning.Views
{
    ...
    public partial class MemoriseView : MvxViewController<MemoriseViewModel>, IAnswerClick
	{
        ExerciseModel Item;
        int PositionStep = 1, PositionMax;
        MemoriseBaseView ExerciseBody;

		public MemoriseView (IntPtr handle) : base (handle)
		{
		}
        ...
        public override void ViewDidLoad()
        {
			...
			var bindingSet = this.CreateBindingSet<MemoriseView, MemoriseViewModel>();
