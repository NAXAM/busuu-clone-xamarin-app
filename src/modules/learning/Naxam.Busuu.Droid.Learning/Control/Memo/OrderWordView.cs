...
{
    public class OrderWordView : MemoBaseView
    {
        ...
        public OrderWordView(Context context, UnitModel unit) : base(context)
        {
            Item = unit;
            InitView(context);
        }
        ...
        {
            RemoveAllViews();
            View view = LayoutInflater.FromContext(context).Inflate(Resource.Layout.order_word_layout, null);
