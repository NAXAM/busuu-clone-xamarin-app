...
{
    [NxFragment(BusuuFragmentHosts.Memorise,  ViewModelType = typeof(MatchingSentenceViewModel))]
    public class MatchingSentenceFragment : MvxFragment<MatchingSentenceViewModel>, View.IOnTouchListener
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = this.BindingInflate(Resource.Layout.matching_sentence_layout, container, false);
            Init(view);
            return view;
        }
        ...
        private void Init(View view)
        {
            ...
            for (int i = 0; i < ViewModel.Item.Inputs.Count; i++)
            {
                MatchingSentence.Add(ViewModel.Item.Answers[i].Text, ViewModel.Item.Inputs[i]);
            }
        ...
        public bool OnTouch(View view, MotionEvent motionEvent)
        {
            ...
            switch (motionEvent.Action)
            {
                ...
                case MotionEventActions.Up:
                    ...
                    if (FinishLesson())
                    {
                        ViewModel.IsCorrect = FinishLesson();
                        DisableView();
                        //
