...
{
    public class FavoriteReviewTableViewSource : MvxTableViewSource, INotifyPropertyChanged
    {		
		...
		public FavoriteReviewTableViewSource(UITableView tableView) : base(tableView)
        {
		...
		{
            return ReviewView.groupFavorite[section].Count();
		}

		[Export("numberOfSectionsInTableView:")]
        public override nint NumberOfSections(UITableView tableView)
		{
            return ReviewView.groupFavorite.Count();
		}

		[Export("tableView:titleForHeaderInSection:")]
        public override string TitleForHeader(UITableView tableView, nint section)
		{
			return ReviewView.groupFavorite[section].Key.ToString().ToUpper();
		}

		protected override object GetItemAt(NSIndexPath indexPath)
		{
			if (ReviewView.groupFavorite == null) return null;
			var section = ReviewView.groupFavorite[indexPath.Section];
