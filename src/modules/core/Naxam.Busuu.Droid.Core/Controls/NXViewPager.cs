...
{
    public class NXViewPager : ViewPager
    {
        ...
        public NXViewPager(Context context, IAttributeSet attrs) : base(context, attrs)
        {

        }
        public NXViewPager(Context context) : base(context)
        {
