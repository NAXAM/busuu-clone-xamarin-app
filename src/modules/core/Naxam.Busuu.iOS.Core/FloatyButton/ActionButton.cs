...
namespace Naxam.Busuu.IOS.Core.Floaty
{
    public class ActionButton : NSObject
    {
        ...
        public ActionButton(UIView view, ActionButtonItem[] itemss, UIColor backgroundColor, UIColor backgroundColorSelected) : base()
        {
            ...
            FloatButton.TitleLabel.Font = UIFont.FromName("HelveticaNeue-Light", 32);
            ...
            ContentView.Frame = new CGRect(0, 10, bounds.Width, bounds.Height);

            blurVisualEffect = new UIVisualEffectView(UIBlurEffect.FromStyle(UIBlurEffectStyle.ExtraLight));
            blurVisualEffect.Layer.Opacity = 0.7f;
...
*/
        void InstallConstraints()
        {
			...
			var height = NSLayoutConstraint.FromVisualFormat("V:[FloatButton(FloatButtonRadius)]-18-|", NSLayoutFormatOptions.AlignAllCenterX, metric, views);
